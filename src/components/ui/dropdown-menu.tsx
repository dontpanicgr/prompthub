...
// Floating Menu Component - Reusable across the app
//
// Usage Examples:
//
// 1. Basic User Menu:
...
//     { label: 'Sign Out', icon: <LogOut />, onClick: handleSignOut, variant: 'destructive' }
//   ]}
// />
//
// 2. Context Menu:
...
//     { label: 'Paste', icon: <Paste />, onClick: handlePaste, disabled: !canPaste },
