  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Overview of your platform's key metrics and performance</p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                <p className="text-sm font-medium text-foreground">Top Prompt</p>
                <p className="text-sm text-muted-foreground truncate">{analytics.topPrompt}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-foreground">Top User</p>
                <p className="text-sm text-muted-foreground">@{analytics.topUser}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">New prompt created</p>
                <p className="text-xs text-muted-foreground">"Advanced React Patterns" by john_doe</p>
              </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">jane_smith joined the platform</p>
              </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Prompt "AI Best Practices" reached 100 likes</p>
              </div>
